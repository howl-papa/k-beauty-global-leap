...
export default function DashboardLayout({
  ...
  const { isAuthenticated, user, logout, fetchCurrentUser, isLoading } = useAuthStore();
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar */}
        <aside className="w-64 bg-white min-h-[calc(100vh-4rem)] shadow-sm border-r border-gray-200">
          <nav className="p-4 space-y-2">
            <Link
              href="/dashboard"
              className="flex items-center space-x-3 px-4 py-3 text-gray-700 hover:bg-primary-50 hover:text-primary-700 rounded-lg transition"
            >
